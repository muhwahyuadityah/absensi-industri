                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mt-6">
                       <a href="{{ route('karyawan.riwayat') }}" 
                        class="inline-flex items-center gap-2 px-6 py-3 bg-gray-800 border border-transparent rounded-md font-semibold text-sm text-white hover:bg-gray-700 focus:bg-gray-700 active:bg-gray-900 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition">
                            <span>📋</span>
